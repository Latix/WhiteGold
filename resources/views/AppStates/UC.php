...
<head>
   ...
   <!-- CSS
   ================================================== -->
   <link rel="stylesheet" href="<?= __file(CSS.'base.css'); ?>">  
   <link rel="stylesheet" href="<?= __file(CSS.'vendor.css'); ?>">  
   <link rel="stylesheet" href="<?= __file(CSS.'main.css'); ?>">    

   <!-- Modernizr
   =================================================== -->
   <script src="<?= __file(JS.'modernizr.js'); ?>"></script>

   <!-- Favicons
   =================================================== -->
   <link rel="shortcut icon" href="<?= __file(CSS.'favicon.png'); ?>" >
...
<!-- Script
=================================================== -->
<script src="<?= __file(JS.'jquery-1.11.3.min.js'); ?>"></script>
<script src="<?= __file(JS.'jquery-migrate-1.2.1.min.js'); ?>"></script>
<script src="<?= __file(JS.'jquery.fittext.js'); ?>"></script>
<script src="<?= __file(JS.'jquery.countdown.min.js'); ?>"></script>
<script src="<?= __file(JS.'jquery.placeholder.min.js'); ?>"></script>
<script src="<?= __file(JS.'owl.carousel.min.js'); ?>"></script>
<script src="<?= __file(JS.'jquery.ajaxchimp.min.js'); ?>"></script>
<script src="<?= __file(JS.'main.js'); ?>"></script>
